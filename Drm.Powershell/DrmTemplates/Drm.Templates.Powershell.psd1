...
FunctionsToExport = @('Set-SolutionWorkflowsState','New-DrmTemplate','Set-SolutionEnvironmentVariables', 'Connect-CrmOnline','Get-DynamicsAutoNumber','Set-DynamicsAutoNumber')
